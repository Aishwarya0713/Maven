...
import resources.base;
	...
	public class Kudos_to_me extends base {
		...
		public void kudotome() throws IOException, InterruptedException, AWTException {
			clickkudo();
			WebElement wb = driver.findElement(By.xpath("//span[contains(.,'Kudos to me')]"));
			wb.click();
			Thread.sleep(3000);
		}
